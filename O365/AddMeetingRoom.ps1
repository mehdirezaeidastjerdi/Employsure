...
Add-DistributionGroupMember –Identity "Sydney Meeting Rooms" -Member "SYD5.2MeetingRoom@peninsula-au.com"
...
Add-DistributionGroupMember –Identity AllMeetingRooms -Member "SYD5.2MeetingRoom@peninsula-au.com"
...
Add-MailboxFolderPermission SYD5.2MeetingRoom@peninsula-au.com:\calendar -user Jade.Yee@employsure.com.au -accessright Owner
Add-MailboxFolderPermission SYD5.2MeetingRoom@peninsula-au.com:\calendar -user Nathan.Coakley@employsure.com.au -accessright Owner
Add-MailboxFolderPermission SYD5.2MeetingRoom@peninsula-au.com:\calendar -user Caitlyn.Fehily@employsure.com.au -accessright Owner
