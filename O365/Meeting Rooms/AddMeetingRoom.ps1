...
Add-DistributionGroupMember –Identity "Sydney Meeting Rooms" -Member "SYD6.2MeetingRoom@peninsula-au.com"
...
Add-DistributionGroupMember –Identity AllMeetingRooms -Member "SYD6.2MeetingRoom@peninsula-au.com"
