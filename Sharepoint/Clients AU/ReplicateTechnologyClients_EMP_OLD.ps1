...
$DestSite = "Technology"
$DestLib = "Clients_EMP_OLD_Replica"
$MatchedFilePath = "C:\temp\AllSharepointItems_Technology_Clients_EMP_OLD.csv"
$CopiedItemsPath = "C:\temp\successfullyCopiedItems_Technology_Clients_EMP_OLD.csv"
$NotExistInSourceItemsPath = "C:\temp\NotExistInSourceItems_Technology_Clients_EMP_OLD.csv"
