...
$MatchedFilePath = "c:\temp\FilteredFolders 1.csv"
$CopiedItemsPath = "C:\temp\successfullyCopiedItems.csv"
$NotExistInSourceItemsPath = "C:\temp\NotExistInSourceItems.csv"
